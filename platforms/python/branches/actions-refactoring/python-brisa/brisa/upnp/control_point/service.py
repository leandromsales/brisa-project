...
class StateVariable(BaseStateVariable):
    ...
    def subscribe(self, callback):
        # TODO implement unicast eventing
        pass
...
class Service(BaseService):
    ...
    def _fetch_scpd_async_error(self, error=None, cb=None):
    ...
    def subscribe_for_variable(self, var_name, callback):
        ...
        """
        log.warning('subscribe_for_variable not fully implemented.')
        if var_name in self._state_variables:
            # TODO write the subscribe() method for StateVariable class of this
            # module.
