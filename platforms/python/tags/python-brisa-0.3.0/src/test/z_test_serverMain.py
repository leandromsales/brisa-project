...
if __name__ == '__main__':
    ...
    myDevice = RootDevice("MediaServer:1", "Cartola MediaServer", uuid, listenURL)
    ...
    sdl =[
          {'klass':FSDirectory, 'title':'Alejandro Sanz', 'path':"/home/adrian/Musicas/Alejandro Sanz"},
          {'klass':FSDirectory, 'title':'All Music', 'path':"/home/adrian/Musicas/"},
          ]
