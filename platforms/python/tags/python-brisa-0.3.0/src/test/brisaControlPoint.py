...
from media_devices.control_point.control_point_manager import ControlPointManager
...
class ControlPointGUI(object):
    ...
    def browse(self, widget, id, udn):
        ...
        self.controlPointManager.browse(id, udn)
...
#        self.searchButton.connect("clicked", self.searchDevice, 'uuid:YZiZCWuAqnRcLnhLuMUh')
#        self.window.add(self.searchButton)
#        self.searchButton.show()

        self.browseButton = gtk.Button("Browser the server")
        self.browseButton.connect("clicked", self.browse, '2', 'uuid:UdkQESnvaWgjtfeAWfzy')
        ...
        self.controlPointManager = ControlPointManager()
