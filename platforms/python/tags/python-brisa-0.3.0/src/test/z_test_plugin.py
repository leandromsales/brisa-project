...
def main():
    ...
    plugin_manager.add_plugin('filemp3',
                       '/media/sda8/musik/planet_hemp/usurio', webResource = content, urlbase = "http://192.168.1.74/content/")
#    plugin_manager.add_plugin('file',
#                       '/home/adrian/Musicas/Ayreon - Into The Electric Castle:/home/adrian/Musicas/Alejandro Sanz/1 - Viviendo deprisa:/home/adrian/Musicas/Audioslave/Audioslave:/home/adrian/Musicas/DragonForce - 2005 - Inhuman Rampage - Advance')
