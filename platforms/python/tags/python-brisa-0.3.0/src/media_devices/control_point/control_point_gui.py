...
class ControlPointGui(object):
    ...
    def __init__(self):
        ...
        # Glade file
        self.glade_xml = gtk.glade.XML("media_devices/control_point/control_point_gui.glade")
    ...
    def create_item_media_list(self):
        ...
        self.item_media_list_treeview.connect("row_activated", self._on_play_clicked)
        # create the TreeViewColumn to display the data
...
#        menu.append(help_item)
    ...
    def refresh(self):
        print "search device refresh event..."
    ...
    def _generate_combo(self,type):
        ...
        for key in dict:
            list_store.append([dict[key].get_friendly_name(), dict[key].ge
