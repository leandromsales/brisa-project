...
#            self.observer.notify(self.name)
        # precisa destroir o plugin, ja que ele foi repassado pra thread?
...
class PluginManager(object):
    ...
    def add_plugin(self, type, *args,**kwargs):
        ...
        try:
            ...
            logging.show_exception("Error while trying to add plugin " + type, e)
    ...
    def exec_plugins(self):
        ...
        for p in self.plugins:
            try:
                ...
                logging.show_exception("Error while trying to load plugin " + p.name, e, 1)
