    ...
    QMainWindow(parent)
{
    ...
    splash
            = new QSplashScreen(
                    QPixmap(
                            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/BrisaSplashScreenControlPoint.png"));
    ...
    networkItem->setIcon(0, QIcon(
            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/network.png"));
...
void controlpointgui::createActions()
{
    ...
    expandAction->setIcon(QIcon(
            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/plus.png"));
    ...
    collapseAction->setIcon(QIcon(
            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/minus.png"));
    ...
    aboutCpAction->setIcon(QIcon(
            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/info.png"));
...
void controlpointgui::createDeviceItem()
{
    ...
    if(currentDev->getIconList().size() > 0){
        ...
        currentDeviceItem->setIcon(0, QIcon("../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/device.png"));
...
void controlpointgui::addItem(QTreeWidgetItem *deviceItem)
{
    ...
    for (int i = 0; i < listService.size(); i++) {
        ...
        serviceitem->setIcon(
                0,
                QIcon(
                        "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/service.png"));
        ...
        for (int j = 0; j < listAction.size(); j++) {
            ...
            actionItem->setIcon(
                    0,
                    QIcon(
                            "../BrisaDebExamples_Linux/usr/share/pixmaps/brisa/call.png"));
