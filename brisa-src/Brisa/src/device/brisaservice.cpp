...
void BrisaService::call(const QString &method, BrisaInArgument param, WebserverSession *session)
{
...
void BrisaService::buildWebServiceTree(Webserver *sessionManager)
{
    ...
    connect(control, SIGNAL(requestReceived(QString,BrisaInArgument,WebserverSession*)),
            this, SLOT(call(QString,BrisaInArgument,WebserverSession*)));
    connect(control, SIGNAL(invalidRequest(WebserverSession*)),
            this, SLOT(onInvalidRequest(WebserverSession*)));
...
void BrisaService::onRequest(const HttpRequest &request, WebserverSession *session)
{
...
inline void BrisaService::respondAction(WebserverSession *session, const BrisaOutArgument *outArgs, const QString &actionName)
{
...
inline void BrisaService::respondError(WebserverSession *session, int errorCode, QString errorDescription)
{
    if (errorDescription == "") {
