...
#include "../../../include/upnp/controlpoint/av_controlpoint/didl/container.h"
...
static const char qt_meta_stringdata_Container[] = {
    "Container\0"
};
...
const QMetaObjectExtraData Container::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Container::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Container,
      qt_meta_data_Container, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Container::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Container))
