...
brisaConfGui::brisaConfGui(QWidget *parent) : QMainWindow(parent)
{
    ...
    splash = new QSplashScreen(QPixmap("/usr/share/pixmaps/brisa/BrisaSplashScreenConfiguration.png"));
    contSplashScreen = 0;
    linecont = 0;
    QString configPath("./");
...
void brisaConfGui::processSplashScreen()
{
    ...
    case 1:
        splash->showMessage(QObject::tr("Setting up Brisa Configuration..."),topLeft, Qt::blue);
        break;
    case 2:
        splash->showMessage(QObject::tr("Creating Brisa Configuration..."),topLeft, Qt::blue);
        break;
    }
