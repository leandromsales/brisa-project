...
if __name__ == "__main__":
    ...
    service = Service("http://www.cartola.com.br/", "MediaServer/control/", "MediaServer/events/", "MediaServer/presentation/", "MediaServer/scdp/")
    ...
    emb_device = Device("CartolaEmbeddedDevice:1", "CartolaEmbeddedDevice", "udn", "Cartola:1", "location")
