...
class RenderingControl(ServiceControl):
    ...
    def soap_GetVolume(self, *args, **kwargs):
        """ This action retrieves the current value of the Volume state variable of the
        specified channel for the specified instance of this service"""
    ...
    def soap_SetVolume(self, *args, **kwargs):
         """ This action sets the Volume state variable of the specified instance and channel
