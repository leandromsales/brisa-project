...
class Device(object):
    ...
    listenPort = property(lambda self: int(self.location.split(":")[2]))

    def __init__(self, device_type_version, friendlyName, location, udn=None,
                 parent=None):
        self.parent = parent
        ...
        self.device_type_version = UPnPDefaults.DEVICE_TYPE_VERSION_PREFIX + \
                                        device_type_version
    ...
    def generate_udn(self):
        return ''.join(['uuid:'] + \
                       [random.choice(string.letters) for x in xrange(20)])
...
class RootDevice(Device):
    ...
    def __init__(self, device_type_version, friendlyName, location, udn=None,
                     parent=None):
        Device.__init__(self, device_type_version, friendlyName, location, udn,
                            parent)
        self.devices = []
