...
class SSDPServer(DatagramProtocol):
    ...
    def registerRootDevice(self, rootDevice):
        if (rootDevice.is_rootDevice()):
            ...
            deviceId = rootDevice.udn
            deviceType = rootDevice.device_type_version
            deviceServer = "Twisted, UPnP/1.0, " + self.server
            deviceLocation = rootDevice.location + '/root-device.xml'
            ...
            for service in rootDevice.services:
                serviceType = service.service_type_version
