...
class UDPTransport:
    ...
    def send_data(self, data, (host, port)):
        """ Sends an UDP datagram to the address specified. This is a
        non-blocking method.
        ...
        @type port: integer
        """
        ThreadManager().run_async_function(self.socket.sendto,
                                           (data, (host, port)))
    ...
    def send_delayed(self, delay, data, (host, port)):
        ...
        @type port: integer
        """
        t = Timer(delay, self.send_data, args=[data, (host, port)])
        t.start()
...
class TCPTransport:
    ...
    def send_data(self, data, (host, port)):
        ...
        @type port: integer
        """
        ThreadManager().run_async_function(self._send_data,
                                           (data, (host, port)))
