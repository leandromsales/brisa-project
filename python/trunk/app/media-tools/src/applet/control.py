...
class ControlGUI(object):
    ...
    def server_rescan(self, widget):
        ...
        try:
            ...
            log.debug('Could not rescan folders. Reason %s' % str(e))
    ...
    def server_reload(self, widget):
        ...
        try:
            ...
            log.debug('Could not reload config. Reason: %s' % str(e))
    ...
    def stop_server(self):
        ...
        try:
            ...
            self.server_proxy = None
            log.debug('Could not stop server. Reason: %s' % str(e))
    ...
    def stop_renderer(self):
        ...
        try:
            ...
            self.renderer_proxy = None
            log.debug('Could not stop renderer. Reason: %s' % str(e))
    ...
    def get_server_info(self):
        ...
        try:
            ...
            self.server_proxy = None
            log.debug('Could not retrieve server info. Reason: %s' % str(e))
            return ('', ) * 7
