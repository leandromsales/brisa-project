...
from brisa_userprofile_server.services.up_profile.persistence.database import Relationship
...
class UserPreferenceDescriptionMessage(object):
    ...
    def __init__(self, username, password):
        ...
        user = User.select(User.q.username == username)
    ...
    def dump_xml(self):
        ...
        self.to_xml(path.join(config.manager.brisa_home, '"userPreference"'))
